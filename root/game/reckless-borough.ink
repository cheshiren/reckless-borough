...
{cooling_towers_market:
	- 1: Далеко на фоне поднимаются из тумана колоссы трёх градирен, уже более сорока лет не работающих. Их серая вертикальная поверхность покрыта жилыми постройками [button=squat]сквоттеров[/button], как киль корабля ракушками.
...
{cooling_towers_mecha:
	- 1: На фоне детей видны колоссы трёх градирен, уже более сорока лет не работающих. Их серая вертикальная поверхность покрыта жилыми постройками [button=squat]сквоттеров[/button], как киль корабля ракушками.
...
<> редкая толпа окружила площадку, на которой группа подростков играет в [button]кабадди[/button]. Снимок сделан как раз в тот момент, когда нападающий одной из команд прыгает, чтобы вернуться на свою половину. Его загорелая рука вытянулась к разделительной линии, пытаясь достать её самыми кончиками пальцев. Двое оппонентов повисли у него на ногах, третий тянет за поношенную розовую джерси с логотипом [button=jpp]«Jaipur Pink Panthers»[/button].
...
<>, снимающий из-за прилавка на большой винтажный Полароид, и <>
{man_red:
	- 1: угрюмый
	- 2: тот же
}
<> седой мужчина рядом. <>
{arm_red:
	- 1: Вместо правой руки у мужчины — восьмипалый протез бывшего военного.
...
{arm_coffee:
	- 1: Крупный план старого военного протеза с восемью пальцами, которые сжимают <>
	{sack_coffee:
...
<> Сверху мешок прострочен красной нитью, её концы спаяны круглой печатью с оттиском радиальной [button]датаматрицы[/button]. Красными же чернилами на мешок нанесена надпись: [button]«Café hidropônico de São Paulo»[/button].
...
<> и красный [button]сигаретный блок[/button].
...
= interlude
# CLASS: second-face
…Ты замечаешь ещё одну фотографию под всеми остальными. Если бы не моргнувший ярлык «Папа», ты бы её даже не увидел…
